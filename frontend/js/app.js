...
function initMap() {
    ...
    baseTileLayers['dark'] = L.layerGroup([esriDarkBase, esriDarkRef]).addTo(map);
    ...
    // 3. OpenStreetMap Streets (100% Community Free, Zero Watermark, No API Key)
...
/** Export Evaluated Candidate Sites CSV */
